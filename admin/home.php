                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-default" type="button">
												 Nouvelles réservations de chambres  <span class="badge"><?php echo $c ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Chambres réservées  <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class="panel panel-danger">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Suiveurs  <span class="badge"><?php echo $f ; ?></span>
											</button>
											</a>
                                        </h4>
                                    </div>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
										...
										<?php
											if(isset($_POST['up'])){
												$sql='UPDATE login 
													SET usname="'.$_POST['usname'].'", pass="'.$_POST['pass'].'" 
													WHERE usname="'.$fname.'"';
												// Prepare statement
