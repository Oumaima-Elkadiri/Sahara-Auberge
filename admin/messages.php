        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Lettres d'information</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Réservation de chambre</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                         <small>  Panneau de</small> lettres d'information
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Envoyez les lettres d'information aux abonnés</h3>
						<?php
						...
						<div class="panel-body">
                            <button class="btn btn-primary btn" data-toggle="modal" data-target="#myModal">
                              Envoyer de nouvelles lettres d'information
                            </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Rédiger une lettre d'information</h4>
                                        </div>
										<form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Titre</label>
                                            <input name="title" class="form-control" placeholder="Entrez le Titre">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Sujet</label>
                                            <input name="subject" class="form-control" placeholder="Entez le Sujet">
											</div>
                                        </div>
										<div class="modal-body">
										<div class="form-group">
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
														...
														<td>".$row['cdate']."</td>
														<td>".$row['approval']."</td>
														<td><a href=newsletter.php?eid=".$id ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> Autorisation</button></td>
														<td><a href=newsletterdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Effacer</button></td>
													</tr>";
											}
											else
											{
