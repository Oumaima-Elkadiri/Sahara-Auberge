...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SAHARA AUBERGE</p>
				<p>Hassilabied 52202,<br>Merzouga.</p>
				<p>+212606786512</p>
			</address>
			<span><img alt="" src="assets/img/sahara.png" width="187" height="241"></span>
		</header>
		<article>
			<h1>Destinataire</h1>
			<address >
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix></span><span ><?php  echo $type_of_room;?>DH</span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix></span><span><?php echo $ttot; ?>DH</span></td>
					</tr>
					<tr>
						<td><span ><?php echo $meal; ?>  </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix></span><span ><?php  echo $type_of_meal?>DH</span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix></span><span><?php echo $mepr; ?>DH</span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					<th><span >Le total</span></th>
					<td><span data-prefix></span><span><?php echo $fintot; ?></span>DH</td>
				</tr>
		...
		<aside>
			...
			<div >
				<p align="center">Courriel :saharaauberge@gmail.com|| Web :- www.SAHARA AUBERGE.com || Téléphone :- +212606786512</p>
			</div>
		</aside>
	</body>
</html>
